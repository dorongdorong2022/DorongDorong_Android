...
- 카카오대표이사상 🏆
- 배운 것들
    * 처음으로 기획, 디자이너, 백엔드가 모두 있는 프로젝트를 진행하며 **협업**의 가치를 경험
    * AOS와 iOS 각각 1명으로 팀을 구성한 만큼 서로 맡은 역할을 다 해내야만 하는 **책임**을 경험
    * 이틀간 3시간만 자면서 목표를 향해 쉬지 않고 달려가는 **몰입**을 경험
    * 3박 4일이라는 짧은 기간 동안 유의미한 성과를 보이기 위해 팀원들과 고민하고, 협업하며 **MVP**의 가치를 경험
